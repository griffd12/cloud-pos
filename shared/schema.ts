...
export const insertPrintAgentSchema = createInsertSchema(printAgents).omit({ id: true, createdAt: true, lastHeartbeat: true, lastConnectedAt: true, lastDisconnectedAt: true, status: true, agentVersion: true, hostname: true, ipAddress: true }).extend({
